...
// variable: its a container to store value.

//function: a block of code its will executed when it is called.

   // Datatypes

   // There are two data types primitive and non- primitive.

   // Boolean - (True /False), Strings - (Words, sentence, mix of numbers and words(ex - address)),
   // Number - (integer and decimal values), 2 ,4, 101, 23.50, 34.99 
